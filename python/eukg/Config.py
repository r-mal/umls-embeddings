...
# control options
tf.flags.DEFINE_string("data_dir", "/users/rmm120030/working/umls-mke/new", "training data directory")
tf.flags.DEFINE_string("model_dir", "/users/rmm120030/working/umls-mke/new/model", "model directory")
...
tf.flags.DEFINE_string("summaries_dir", "/users/rmm120030/working/umls-mke/new/model", "model summary dir")
tf.flags.DEFINE_integer("batch_size", 564, "batch size")
tf.flags.DEFINE_bool("load", False, "Load model?")
tf.flags.DEFINE_bool("load_embeddings", False, "Load embeddings?")
tf.flags.DEFINE_string("embedding_file", None, "Embedding matrix npz")
...
tf.flags.DEFINE_integer("val_progress_update_interval", 1800, "Number of batches between progress updates")
...
tf.flags.DEFINE_integer("vocab_size", 3210965, "Number of unique concepts+relations")
...
# distmult params
tf.flags.DEFINE_float("regularization_parameter", 1e-4, "Regularization term weight")
